...
#print(check_output(["ls", "D:\\MachineLearning\\Data_science\\kkbox-music-recommendation-challenge\\"]).decode("utf8"))

# Any results you write to the current directory are saved as output.


print('Loading data...')
data_path = 'D:\\MachineLearning\\Data_science\\kkbox-music-recommendation-challenge\\'
...
#AM_train['product_category_2'] = AM_train['product_category_2'].cat.add_categories('NaN')
#AM_train['product_category_2'].fillna('NaN', inplace =True) 

train['lyricist'] = train['lyricist'].cat.add_categories('no_lyricist');
train['lyricist'].fillna('no_lyricist',inplace=True)
#print(train['lyricist'])
...
#cm_f1 = confusion_matrix(ids, p_test_1)
#cm_f2 = confusion_matrix(ids, p_test_2)
#
#print()
